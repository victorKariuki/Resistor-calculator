...
class ResistorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Rect rightLead = Rect.fromLTWH(
      width - leadWidth,
      leadY,
      leadWidth,
      leadHeight,
    ...
    _drawBand(
      canvas,
      startX + leftBandCount * bandSpacing,
      height,
      bodyHeight,
      bandWidth,
      bandColors[leftBandCount],
    );
    ...
    if (bandCount > 3) {
      ...
      if (bandCount == 6) {
        _drawBand(
          canvas,
          rightStartX - bandSpacing,
          height,
          bodyHeight,
          bandWidth,
          bandColors[bandCount - 2],
        ); // Tolerance
        _drawBand(
          canvas,
          rightStartX,
